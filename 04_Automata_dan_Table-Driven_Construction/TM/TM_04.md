...
![Output dari Tugas Mandiri](./Tm_04.png).
...
Untuk fungsionalitasnya, saya mengembangkan logika JavaScript yang mampu menghitung jumlah karakter, huruf besar, dan huruf kecil secara real-time menggunakan Regular Expression. Selain itu, aplikasi ini dilengkapi fitur pemilih mode (gelap, terang, dan sepia) untuk kenyamanan visual pengguna.
